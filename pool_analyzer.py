...
st.sidebar.markdown("**Note:** For conservative projections, consider halving the entered APY to buffer against market volatility. 
Global Average Inflation Hurdle Rate: 5% (as of 2025). This is the minimum return needed to outpace global inflation. Compare this to your pool APY to ensure real returns.")
